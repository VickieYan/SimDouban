...
.moviedetail .main .part1 {
  position: relative;
}
.moviedetail .main .part1 i {
  font-style: normal;
  padding: 0 0.1rem;
}
.moviedetail .main .part1 h3 {
  font-size: 0.8rem;
}
.moviedetail .main .part1 p {
  font-size: 0.2rem;
  color: #666;
  line-height: 1rem;
}
.moviedetail .main .part1 .rating {
  width: 2rem;
  height: 2rem;
...
.moviedetail .main .part1 .rating h5 {
  font-weight: normal;
  font-size: 0.2rem;
  color: #ccc;
  line-height: 0.8rem;
}
.moviedetail .main .part1 .rating p {
  font-weight: bold;
  font-size: 0.8rem;
  color: #fe7a3f;
  line-height: 1.1rem;
}
.moviedetail .main .part2 {
  text-align: center;
  padding-top: 0.8rem;
  border-bottom: 0.01rem solid #ccc;
  padding-bottom: 0.5rem;
}
.moviedetail .main .part2 .wrap {
  width: 90%;
  display: inline-block;
  overflow: hidden;
}
.moviedetail .main .part2 .wrap .btn {
  color: orange;
  height: 1.2rem;
  line-height: 1.2rem;
  font-size: 0.5rem;
...
.moviedetail .main .part2 .wrap .btn1 {
  float: left;
}
.moviedetail .main .part2 .wrap .btn2 {
  float: right;
}
.moviedetail .main .part3 {
  padding-top: 0.2rem;
}
.moviedetail .main .part3 h5 {
  font-weight: normal;
  font-size: 0.2rem;
  color: #ccc;
  line-height: 0.8rem;
}
.moviedetail .main .part3 p {
  font-size: 0.5rem;
  color: black;
  line-height: 0.8rem;
  text-indent: 2em;
}
.moviedetail .main .part3 p span {
  color: #3fc046;
  margin-left: 0.2rem;
}
.moviedetail .main .part4 {
  padding-top: 0.2rem;
}
.moviedetail .main .part4 h5 {
  font-weight: normal;
  font-size: 0.2rem;
  color: #ccc;
  line-height: 0.8rem;
