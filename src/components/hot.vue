...
<style>
	.hot{width: 100%;text-align: left;}
	.hot .title .line{height: .68rem;width: .14rem;background-color: #fe7a3f;margin-right: .52rem;display: inline-block;vertical-align: bottom;}
	.hot .title p{font-size: .46rem;color: #fe7a3f;display: inline-block;height: .58rem;line-height: .58rem;vertical-align: bottom;}
</style>